        ...
        <CardContent className="p-0">
          {loading ? (
            ...
            <div className="divide-y">
              <div className="hidden sm:grid grid-cols-[1fr_100px_160px_140px_60px] gap-4 px-6 py-3 text-xs font-medium text-muted-foreground uppercase tracking-wide">
                <span>Code</span>
                <span>Discount</span>
                <span>Status</span>
                <span>Created</span>
              ...
              {codes.map((code, i) => (
                <div key={code.id}>
                  {i > 0 && <Separator />}
                  <div className="flex flex-col sm:grid sm:grid-cols-[1fr_100px_160px_140px_60px] gap-2 sm:gap-4 items-start sm:items-center px-6 py-4">
